import 'dart:io';
import 'dart:math';
import 'package:ex3/seguradora.dart' as seguradora;
import 'package:ex3/seguradora.dart';
import 'package:ex3/apolice.dart' as apolice;
...
void main(List<String> arguments) {
    ...
    print("4 - Quantidade de apólices inativas e valor médio segurado por seguradora");
    ...
    var escolha = int.parse(input);
      switch(escolha){
        case 1: 
          ...
          stdout.write(apolices.where((element) => element.ativo == true).length); //mostra a quantidade de apolices quando o elemento "ativo" for "true"
        ...
        case 2: 
          stdout.write("Existem ");
          stdout.write(apolices.where((element) => element.ativo == false).length); //mostra a quantidade de apolices quando o elemento "ativo" for "false"
        ...
        print("-- Apolices --\n");
          apolices.forEach((element){
            print(
            'Nome do Tomador: ${element.nomeTomador}\n'
